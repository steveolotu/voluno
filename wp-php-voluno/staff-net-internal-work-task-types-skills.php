...
if(0!=0){
	...
	if(1==1){
		...
		## Last documentation check: 2000.09.19, Steve
		## Last format and structure check: 2000.09.19, Steve
...
if(1==1){ ///2
	...
	if(1==1){
		...
		$general_information = '
		<p>
			This page is only accessible to the positions: <b>Human Resources Officer, Moderator, Web Developer</b>
			<br>It has the following purposes:
		</p>
		<ul>
			<li>
				Provide overview of all Task Types
			</li>
		</ul>
		<br>';
...
if(!array_intersect($function_userpositions_get['simple array']['accepted'],['Voluno Moderator','Voluno Staff Member','Voluno Human Resources Officer'])){ ///3
	
	echo '
	<p style="color:red;">
		You are don\'t have access to this page since you don\'t have the required positions.
	</p>
	';
