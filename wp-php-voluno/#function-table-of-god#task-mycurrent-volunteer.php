...
elseif($table_of_god_content_td_number == 7){
  ...
  <td style="text-align:center;vertical-align:middle;">';
    if($table_of_god_internal_results[$x]->tog_data_string3 == "unassigned"){
      $table_of_god .= '
      <div class="mycurrent_volunteer_withdraw_application_link">
        <a
          style="cursor:help;text-weight:bold;"
          title="You applied for this task. The task authors will now go through all applications and choose the best suited candidate."
        >
          Application pending.
        </a>
        <br>
        <img style="width:50px;" src="'.wp_upload_dir()['url'].'/pictures/clock.png">'.
        #<div
#            class="
#                voluno_text_button_style
#                mycurrent_volunteer_withdraw_application_button"
#            style="
#                position:absolute;
#                margin-top:-70px;
#                margin-left:55px;
...
#        </div>
      '</div>';
    }elseif($table_of_god_internal_results[$x]->tog_data_string3 == "in progress"){
      $table_of_god .= '
        <a
          style="cursor:help;"
          title="Your application was accepted. Now, please work on this task."
        >
          Ready for your work.
        </a>
        <br>
        <img style="width:50px;" src="'.wp_upload_dir()['url'].'/pictures/working.png">';
    }
    $table_of_god .= '
  </td>
  ';
